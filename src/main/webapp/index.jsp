	...
	<section class="home" id="home">
		...
		<div class="content">
			...
			<p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Rem
				sed autem vero? Magnam, est laboriosam!</p>
			<a href="#" class="btn"> contact us <span
	...
	<section class="book" id="book">
		...
		<div class="row">
			...
			<form action="">
				...
				<input type="text" placeholder="your name" class="box"> <input
					type="number" placeholder="your number" class="box"> <input
					type="email" placeholder="your email" class="box"> <input
					type="date" class="box"> <input type="submit"
					value="book now" class="btn">
			</form>
		...
		<div class="box-container">
			...
			<div class="box">
				...
				<p class="text">Lorem ipsum dolor sit amet consectetur
					adipisicing elit. Laboriosam sapiente nihil aperiam? Repellat sequi
					nisi aliquid perspiciatis libero nobis rem numquam nesciunt alias
	...
	<section class="blogs" id="blogs">
		...
		<div class="box-container">
			...
			<div class="box">
				...
				<div class="content">
					<div class="icon">
						<a href="#"> <i class="fas fa-calendar"></i> 1st may, 2021
